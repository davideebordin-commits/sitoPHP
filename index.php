...
<button class="imageHomeCentrale" onclick="window.location.href='login.php'" style="left:50%; transform:translateX(-50%);"></button>
  ...
  <div class="hero2" style="
    ...
    gap: 30px;
  ">
    <h1 style="color:white; font-style:italic; font-size:4.5em; text-align:center; margin:0; position:relative;">
      LA LOCATION
    </h1>
  </div>
  ...
  <div class="hero3" style="
    ...
    gap: 30px;
  ">
    <h3 style="position:relative; top:auto; left:auto; font-size:2em; text-align:center; color:white;">
      VIENI A TROVARCI
    </h3>

    <div class="mappaHome" style="position:relative; top:auto; left:auto; width:60%;">
      <iframe
